...
public:
	...
	virtual ~UIScene();
	int GetPad() const { return m_iPad; }
...
public:
	...
	void getMovieDimensions(S32 &width, S32 &height) { width = m_movieWidth; height = m_movieHeight; }
...
public:
	...
	void TriggerControlPress(F64 controlId, F64 childId);
	void TriggerDirectMenuAction(int key);
