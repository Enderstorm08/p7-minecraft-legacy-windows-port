...
#ifdef _WIN64
	_UIVec2D m_pointerPos;
	float m_fPointerMinX, m_fPointerMaxX;
	float m_fPointerMinY, m_fPointerMaxY;
...
#ifdef _WIN64
	IggyName m_funcSetCursorPosition;
#endif
...
#ifdef _WIN64
			UI_MAP_NAME( m_funcSetCursorPosition, L"SetCursorPosition")
#endif
