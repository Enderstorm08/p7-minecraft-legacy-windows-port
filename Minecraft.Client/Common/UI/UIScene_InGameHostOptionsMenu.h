...
private:
	enum EControls
	{
		...
		eControl_TNT,
		eControl_HostPrivileges,
		eControl_TeleportToPlayer,
		eControl_TeleportToMe,
	};
	
	UIControl_CheckBox m_checkboxFireSpreads, m_checkboxTNT, m_checkboxHostPrivileges;
	...
	UI_BEGIN_MAP_ELEMENTS_AND_NAMES(UIScene)
		...
		UI_MAP_ELEMENT( m_checkboxHostPrivileges, "CheckboxHostPrivileges")
