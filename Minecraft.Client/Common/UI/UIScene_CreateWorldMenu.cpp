#include "stdafx.h"
#ifdef _WINDOWS64
extern void Windows64RememberSaveTitle(LPCWSTR pwchDefaultSaveName);
#endif
#include "UI.h"
...
void UIScene_CreateWorldMenu::CreateGame(UIScene_CreateWorldMenu* pClass, DWORD dwLocalUsersMask)
{
...
#ifdef _WINDOWS64
	Windows64RememberSaveTitle((wchar_t *)wWorldName.c_str());
#endif
	...
	app.SetGameHostOption(eGameHostOption_CheatsEnabled,pClass->m_MoreOptionsParams.bHostPrivileges);
