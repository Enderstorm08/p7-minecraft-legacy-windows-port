...
//    CompoundTag *loadedPlayerTag;	// 4J removed
	...
	bool bEndGatewayUnlocked;
	int xEndGateway;
	int yEndGateway;
	int zEndGateway;
	int xOuterEndGateway;
	int yOuterEndGateway;
	int zOuterEndGateway;
...
public:
	...
	virtual  bool getHasEndGateway();
	virtual  int getXEndGateway();
	virtual  int getYEndGateway();
	virtual  int getZEndGateway();
	virtual  int getXOuterEndGateway();
	virtual  int getYOuterEndGateway();
	virtual  int getZOuterEndGateway();
	...
	virtual  void setHasEndGateway(bool hasEndGateway = true);
	virtual  void setXEndGateway(int xEndGateway);
	virtual  void setYEndGateway(int yEndGateway);
	virtual  void setZEndGateway(int zEndGateway);
	virtual  void setXOuterEndGateway(int xOuterEndGateway);
	virtual  void setYOuterEndGateway(int yOuterEndGateway);
	virtual  void setZOuterEndGateway(int zOuterEndGateway);
